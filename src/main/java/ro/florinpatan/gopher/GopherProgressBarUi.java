...
public class GopherProgressBarUi extends BasicProgressBarUI {
    ...
    private static final Color GOPHER_COLOR_START = new JBColor(new Color(32, 135, 60), new Color(32, 135, 60));
    private static final Color GOPHER_COLOR_END = new JBColor(new Color(20, 168, 12), new Color(20, 168, 12));
